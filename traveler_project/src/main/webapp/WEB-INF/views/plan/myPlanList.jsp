...
<body>
	...
	<!-- content -->
	<section id="fh5co-work" style="background-image: url(<c:url value='/resources/images/full_image_1.jpg' />);" data-stellar-background-ratio="0.5" data-section="work">
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<h3>간단하게 여행을 계획하세요! 편안하고 즐거운 여행을 보낼 수 습니다! <a href="myPlanInsertForm.go">계획 세우기</a></h3>
						</div>
					</div>
				</div>
			</div>
				...
				<c:forEach items="${planListAll}" var="list">
					<div class="col-md-4 col-sm-6 col-xxs-12">
						...
						<div class="fh5co-text">
							...
							<span class="col-md-12">등록일 : ${list.plan_regDate}</span>
							<hr>

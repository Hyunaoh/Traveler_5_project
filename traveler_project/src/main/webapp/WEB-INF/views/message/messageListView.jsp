...
<!--
받은 /보낸 메세지함 팝업창 크기 및 위치 -->#message #message-nano-wrapper {
	position: absolute;
	top: 225px;
	bottom: 0;
	height: auto;
...
<body>
	...
	<div class="nano-content" style="margin-top: 50px">
		<div class="logo-container" style="font-size: 40px;">
			<a href="messageListView.go"><span class="logo glyphicon glyphicon-envelope"></span>쪽지함</a>
		</div>
		<a onclick="all_message_function()" class="compose-button">전체메일함</a>

		<!-- 왼쪽 메뉴바 -->
		<menu class="menu-segment" id="list_message">
			<ul>
				<li><a href="#" id="messageGet">받은메세지함 <input type="hidden" id="messageGet_total" value="${ messageGet_total }" />(${ messageGet_total })
					</span></a></li>
				<li><a href="#" id="messageSend">보낸메세지함<span> <input type="hidden" id="messageSend_total" value="${ messageSend_total }" />(${ messageSend_total })
					</span></a></li>
	...
	<header class="header" style="height: 20px; padding: 10px 10px;"> 
	<!-- <div class="search-box">
		<input placeholder="Search...">
		<span class="icon glyphicon glyphicon-search"></span>
	</div> -->
	<h1 class="page-title" style="height: 20px; padding: 0px 0px;">
		<a class="sidebar-toggle-btn trigger-toggle-sidebar"> 
		<span class="line"></span> 
		<span class="line"></span> 
		<span class="line"></span> 
		<span class="line line-angle1"></span> <span class="line line-angle2"></span></a>
	...
	<div id="main-nano-wrapper" class="nano">
		<div class="nano-content">
			...
			<ul class="message-list">
				<!-- ajax를 이용한 쪽지함 리스트를 출력함
       	  -- 내용은 보낸메세지함, 받은메세지함, 전체메시지함에 해당됨. -->
			</ul>
	...
	<div id="message">
		...
		<div class="header">
			<h1 class="page-title">
				<a style="line-height: 2;" class="icon circle-icon glyphicon glyphicon-chevron-left trigger-message-close"></a>메세지 내용
			</h1>
		</div>

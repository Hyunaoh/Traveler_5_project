		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-left">
					<h2 class=" left-border to-animate">게시물 관리</h2>
					<div class="row">
			...
			<div class="row">
				<div class="fh5co-counter col-lg-8">
					...
					<c:forEach items="${findList}" var="list">
						<div class="col-md-6 col-sm-6 fh5co-service to-animate cursor-point">
							<img src="" alt="이미지 없음">
							...
							<p><a class="btn btn-default" href="<c:url value='adminBoardDeletePro.go?find_pk=${list.find_pk}' />">삭제</a></p>
						</div>
					</c:forEach>
					
				</div>
				<!-- Side Contents -->
				<div class="fh5co-counter col-lg-4">
					<!-- Title -->
					<div class="col-md-12 subtext to-animate">
						<h3>의심되는 게시물</h3>
						<hr>
					...
					<c:forEach items="${badFindList}" var="badList">
						<div class="col-md-12 col-sm-12 fh5co-service to-animate cursor-point">
							<img src="" alt="이미지 없음">
			...
			<div class="row">
				<div class="fh5co-counter col-lg-7 well">
				...
				<div class="fh5co-counter col-lg-1"></div>
				<div class="fh5co-counter col-lg-4 well">
